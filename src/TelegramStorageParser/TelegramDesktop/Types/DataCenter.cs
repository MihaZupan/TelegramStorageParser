...
namespace MihaZupan.TelegramStorageParser.TelegramDesktop.Types
{
    ...
    {
        private const int DcIdShift = 10000;

        public readonly int Id;
        public int BareDcId => Id % DcIdShift;
        ...
        public DataCenter(int id, byte[] secret = null)
        {
            Id = id;
            Secret = secret;
        ...
        private static readonly Endpoint[][] BuildInDcs =
        {
            ...
            new[] { new Endpoint("149.154.175.100", 443), new Endpoint("2001:0b28:f23d:f003:0000:0000:0000:000a", 443) },
